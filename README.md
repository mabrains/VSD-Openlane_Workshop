...
1. [1st day](#1st-day)
    ...
    5. [A Brief about the ASIC Flow](#A-Brief-about-the-ASIC-Flow)
2. [2nd day](#2nd-day)
    1. [Firstly](#Firstly)
    2. [Secondly](#Secondly)
    3. [Thirdly](#Thirdly)
    4. [Commands Used](#Commands-Used)
    5. [Decoupling Cells](#Decoupling-Cells)
    6. [Ground Bouncing](#Ground-Bouncing)
    7. [Voltage Drop](Voltage-Drop)
    8. [The Solution for Voltage Drop & The Ground Bouncing](#The-Solution-for-Voltage-Drop-&-The-Ground-Bouncing)
    9. [Signal Integrity](#Signal-Integrity)
3. [3rd day](#3rd-day)
    1. [Firstly](#Firstly)
    2. [Secondly](#Secondly)
    3. [Thirdly](#Thirdly)
...
4. [4th day](#4th-day)
    ...
    4. [Fourthly](#Fourthly)
    5. [Commands Used](#Commands-Used)
    6. [Static Timing Analysis-STA](#Static-Timing-Analysis-STA)
5. [5th day](#5th-day)
    1. [Firstly](#Firstly)
    2. [Secondly](#Secondly)
    3. [Thirdly](#Thirdly)
    4. [Fourthly](#Fourthly)
    5. [Commands Used](#Commands-Used)
    6. [Finally Generating the GDS-II](#Finally-Generating-the-GDS-II)
    7. [Routing](#Routing)
    8. [SPEF Extraction](#SPEF-Extraction)
...
Here, we change:
1- The synthesize strategy to make timing it's priority over the area
2- Enable cell sizing in the design.
For more information about these environmental variables, go to Configuration/READmd directory
